...
import { LayoutDashboard, Package, ShoppingCart, Users, Building2, FileText, Target } from 'lucide-react';
...
type Page = 'dashboard' | 'targets' | 'suppliers' | 'purchase_orders' | 'inventory' | 'sales' | 'customers';
